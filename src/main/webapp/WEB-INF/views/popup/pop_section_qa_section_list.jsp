...
<table class="table table-striped">
    ...
    <c:forEach var="result" items="${sectionList}" varStatus="i">
        <tr class="section_row" style="display:${result.delflag?'none':'table-row'};" delflag="${result.delflag}" name ="secTr" id="secTr_${result.shotid}" onclick="getSectionShotListPOP('${result.videoid}', '${result.shotid}', '${result.delflag}', '${result.assetfilepath}', '${result.assetfilename}');">

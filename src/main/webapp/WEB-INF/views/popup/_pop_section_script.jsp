...
<script>
    ...
    /*구간 선택*/
    function getSectionShotListPOP(videoid,shotid,delflag,filepath,filename){
    ...
    /*구간 조회*/
    function getSectionOfSceneListPOP(videoid,sectionid) {
        var $div='';
        $.ajax({
            url: '<c:url value="/popup/section/getSectionOfSceneList"/>',
            type: 'POST',
    ...
    function getQaSectionList(idx) {
        var $div='';
        $.ajax({
            url: '<c:url value="/popup/section/getQaSectionList"/>',
            type: 'POST',
